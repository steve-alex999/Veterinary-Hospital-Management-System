    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        ...
        if (Validate_Save())
        {
            ...
            try
            {
                ...
                dt = ObjIns.getInsertPaitentBAL(UniqueInstId, Vdate, ddl_AnimalType.SelectedValue.ToString(), ddlDoctor.SelectedValue.ToString(), ddlBreed.SelectedValue.ToString(), txtAnimalAge.Text, ddl_AgeMonth.SelectedValue.ToString(), Genger,
                    ...
                    txtmbno.Text.Trim(), rdExempted.SelectedValue, lblRegFee.Text, UserName, "I", purposelist, visttype, txtnos.Text, aadharid, ddlcategory.SelectedValue, ddldivision.SelectedValue, ConnKey, doctorlist);
